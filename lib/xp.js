...
function awardForumXP(db, userId, postId) { _addXP(db, userId, 3, '发布主题', postId); }
...
module.exports = { xpForLevel, _addXP, awardPostXP, awardForumXP, awardCommentXP, awardCheckinXP, awardLikeReceivedXP, awardBookmarkReceivedXP };
